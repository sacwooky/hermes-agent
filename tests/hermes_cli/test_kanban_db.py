...
@pytest.mark.skip(reason="upstream parallel worktree impl not adopted: resolve_workspace materializing .worktrees/<id> on wt/<id> is upstream's contract; the fleet uses ensure_task_worktree (.kanban-worktrees/<repo>/<id>, kanban/<id>) -- see test_dispatch_isolates_builder_task_into_worktree and test_ensure_task_worktree_*. Kept as documentation of the divergence.")
