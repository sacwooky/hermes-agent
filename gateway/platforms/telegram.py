...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # messages — "not supported on Telegram Web" blocks web users (Dottie).
        # Default rich OFF (MarkdownV2 fallback works on every client). Re-enable
        # with telegram extra `disable_rich_messages: false`.
